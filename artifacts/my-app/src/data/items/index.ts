...
// Подмешиваем экономику: sellValue приходит из balance.ts
function withEconomy(item: Item): Item {
  return { ...item, sellValue: getItemSellValue(item.id) };
}
