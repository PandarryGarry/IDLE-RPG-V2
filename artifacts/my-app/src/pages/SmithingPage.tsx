...
export function SmithingPage() {
  ...
  return (
    <div className="space-y-4">
      <SkillHeader skillId="smithing" skillName={t('skill.smithing')} skillIcon={getSkillIcon('smithing')} />
      ...
      <div className="bg-card border border-border rounded-2xl p-4 md:p-5 shadow-sm">
        {isTraining && activeRecipe ? (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                <h3 className="text-lg font-bold flex items-center gap-2">
                  <span className="text-xl">{getSkillIcon('smithing')}</span> {t('smithing.smithing')} {activeRecipe.name}
                </h3>
          ...
          <div className="text-center text-muted-foreground flex flex-col items-center gap-2 py-4">
            <div className="text-4xl opacity-40">{getSkillIcon('smithing')}</div>
